...
//	        response.sendRedirect("");
	 ...
	 * @throws IOException
	 */
	private void insertUserProfile(HttpServletRequest request, HttpServletResponse response, UserProfile user) throws IOException {
		try {
	...
	private void updateUserProfile(HttpServletRequest request, HttpServletResponse response, UserProfile user) throws IOException {
		if (isSessionValid(request)) {
			...
			response.getWriter().print("User Profile by User Name '" + user.getUserName() + "' LOGIN IN FIRST to Update Profile!<BR>");
		}
	}
